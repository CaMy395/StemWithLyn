...
const Clients = () => {
  ...
  const filteredClients = useMemo(() => {
    ...
    return clients.filter((client) => {
      ...
      const haystack = `${client.full_name || ""} ${client.email || ""} ${client.phone || ""} ${client.category || ""} ${client.username || ""}`.toLowerCase();
